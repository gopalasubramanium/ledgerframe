...
| **Severity** (PROPOSED 2026-07-13, page-review ND-11 — ratify at the walk) | How much attention a review item warrants — served values **`review`** (worth a look) and **`info`** (a low-priority nudge, never a hard wall). Rendered **verbatim in a neutral chip** (not a gain/loss/fresh/stale colour). **[Help]** |
