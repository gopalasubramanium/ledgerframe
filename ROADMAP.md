...
| R-17 | Ticker index entries link to Markets | D-047-amend / D-098 | **Owner-ratified 2026-07-11 (page-chrome §11-19).** Ticker **holdings** symbols already link to their instrument-detail page (D-098); **indices** are unlinked for now (no instrument-detail route, and Markets isn't built). When the **Markets page** ships, index entries should link to their canonical home there — a recorded item for the **future Markets page plan** | parked |
